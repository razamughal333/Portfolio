...
- **Multilingual Support** — English, Urdu (RTL), French, German, Spanish
- **AI Chatbot** — powered by Google Gemini 2.5 Flash API, answers questions about Raza
...
├── Raza_Ahmed_CV.docx
├── image-1.jpg       ← Dark theme hero (desktop)
├── image-1a.jpg      ← Dark theme hero (mobile)
├── image-2.jpg       ← Light theme hero (desktop)
├── image-2b.jpg      ← Light theme hero (mobile)
└── README.md
```
