...
- **Dark / Light Theme** — toggleable, with separate background images for each
- **Multilingual Support** — English, Urdu (RTL), French, German, Spanish (all pages now translated)
- **AI Chatbot** — powered by Google Gemini 1.5 Flash API, answers questions about Raza
- **Typing Animation** — role switcher in the hero section
...
> **Note:** This chatbot is powered by Google Gemini AI and secured with domain-level API restrictions.
...
├── projects.html       ← All projects + GitHub API
├── style.css           ← All styles (dark/light themes, responsive, RTL)
├── script.js           ← All JS (theme, i18n, chatbot, typing, etc.)
├── Raza_Ahmed_CV.docx  ← CV file for download
├── image-1.png         ← Dark theme hero (desktop)
├── image-2a.png        ← Dark theme hero (mobile)
├── image-2.png         ← Light theme hero (desktop)
├── image-2b.png        ← Light theme hero (mobile)
└── README.md
```
...
- Google Gemini 1.5 Flash API (chatbot)
...
&copy; 2026 Raza Ahmed — Rawalpindi / Islamabad, Pakistan
